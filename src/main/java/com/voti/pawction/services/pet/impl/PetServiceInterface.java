...
import com.voti.pawction.dtos.request.PetRequests.*;
import com.voti.pawction.dtos.response.PetDto;
import com.voti.pawction.entities.pet.Pet;
import com.voti.pawction.exceptions.pet.PetNotFoundException;
...
public interface PetServiceInterface {
     ...
     * @exception com.voti.pawction.exceptions.UserNotFoundException
     *         if the seller does not exist
     * @exception com.voti.pawction.exceptions.pet.ValidationException
     *         if request fields fail validation (e.g., required attributes missing)
     * @exception com.voti.pawction.exceptions.pet.ImageProcessingException
     ...
     * @exception com.voti.pawction.exceptions.pet.InvalidStateException
     ...
     * @exception com.voti.pawction.exceptions.pet.StorageException
